  ...
  useEffect(() => {
    ...
    const fetchMongoData = async () => {
      try {
        ...
        const productsResponse = await axios.get("https://oneprodex10.up.railway.app/api/products");
        let productsData = [];
        ...
        const categoriesResponse = await axios.get("https://oneprodex10.up.railway.app/api/categories");
        let categoriesData = [];
